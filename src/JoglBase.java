...
public class JoglBase extends GLJPanel implements GLEventListener, KeyListener {
    ...
    private static String TITLE = "Plantilla Base Java OpenGl";  // window's title
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // ------ Modificacion cambio de color lineas ------------
        gl.glColor3f(0.9f, 0.0f, 0.8f);
        ...
        // Cuadro cambio de color --
        gl.glTranslatef(2.0f,2.0f,-1.0f);
        gl.glBegin(GL2.GL_QUADS);
            gl.glColor3f(1.0f, 0.0f, 0.47f);
