...
public class JoglBase2 {
    ...
    private static final String TITLE = "Plantilla Base Java OpenGL";  // window's title
    private final int CANVAS_WIDTH = 640;  // width of the drawable
    private final int CANVAS_HEIGHT = 599; // height of the drawable
...
class Pintor implements GLEventListener {
    ...
    public void display(GLAutoDrawable glad) {
       ...
       gl.glEnd();
        ...
        //aplicacion de color al cono -----------
        gl.glColor3f(1.0f, 0.0f, 0.55f);
        
        //Se anadio una figura ---------
